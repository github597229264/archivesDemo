<template>
	<div class="table">
		<el-form :inline="true" :model="searchForm" class="demo-form-inline">
			<el-form-item>
				<el-input v-model="searchForm.nameAndPinyin" clearable placeholder="输入代码或名称"></el-input>
			</el-form-item>
			<el-form-item>
...
<script>
	...
	export default {
		name: 'NativePlaceFileSelection', //档案选择
		props: ['isledger'],
		components: {
			Pagination //分页组件
		},
		...
		methods: {
			...
			getData() {
				this.$axios({
					...
					data: {
						code: this.API.constObj.CadreCodeDetailsPage[0].id, //出生地
