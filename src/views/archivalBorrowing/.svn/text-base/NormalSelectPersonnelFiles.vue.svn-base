<template>
    <div class="normalSelectPersonnelFiles">
		<el-row :gutter="20">
		  <el-col :span="16">
			<el-form :inline="true" :model="searchForm" class="demo-form-inline">
			  <el-form-item>
			    <AreaTreeSelect v-if="isSearchByArea" v-show="isShowAreaSelect" :defaultOptions="searchForm.departmentID"  @areaTreeSelectCall="areaTreeSelectCall"></AreaTreeSelect>
			    <OrganizationTreeSelect v-else :defaultOptions="searchForm.areaCodeAllID"  @OrgTreeSelectCall="orgTreeSelectCall"></OrganizationTreeSelect>
			  </el-form-item>
			  <el-form-item>
...
<script>
    ...
    export default {
        name: 'NormalSelectPersonnelFiles',//选择档案(多选)--查借阅申请---标准版
	    props:[
	    	'isAreaQuery',//是否区域查询
	    	'mainHeight'//main标签高度
	    ],
		...
		watch:{
        	...
        	tableData(newVal,oldVal){
        		this.tableHeight = this.mainHeight-this.$refs.multipleTable.$el.offsetTop*1 - 52- 52;
        	}
		},
        methods: {
        	/**
            ...
            getData() {
                this.$axios({
					loading:{
            			isShow:true,
            			target:'.normalSelectPersonnelFiles'
            		},
            		method:'post',
                	url:this.API.getA01, 
                	data:{
