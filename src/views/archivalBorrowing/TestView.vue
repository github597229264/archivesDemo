<template lang="html">
	<div id="example">
		...
		<zk-table @checkbox-click="selectionChange" ref="table" sum-text="sum" index-text="#" :data="data" :columns="columns" :stripe="props.stripe" :border="props.border" :show-header="props.showHeader" :show-summary="props.showSummary" :show-row-hover="props.showRowHover" :show-index="props.showIndex" :tree-type="props.treeType" :is-fold="props.isFold" :expand-type="props.expandType" :selection-type="props.selectionType">
...
//				var chioceCode = this.$refs.multipleTable.getCheckedProp("parentcode");
//				console.log(chioceCode);
			},
		},
	};
</script>
